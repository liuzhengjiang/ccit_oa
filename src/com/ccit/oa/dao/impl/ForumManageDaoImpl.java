...
public class ForumManageDaoImpl extends BaseDaoImpl<Forum> implements
	...
	public void moveUp(Long id) {
		//select f.* from ccit_forum f where f.position_ < 11 order by f.position_ desc limit 0,1;
	...
	public void moveDown(Long id){
		// select * from ccit_forum  where position_ > 8 order by position_  limit 0,1;
		Forum forum1 = getById(id);
		int p1 = forum1.getPosition();
